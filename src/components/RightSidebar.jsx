      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            className="p-1 hover:bg-primary/20 dark:hover:bg-primary/20 text-primary dark:text-primary rounded transition-colors"
            title="Manage feeds"
          >
            <Settings size={16} />
          </button>
        ...
        <div className="flex gap-2">
          <button
            onClick={() => setView('all')}
            className={`flex-1 px-3 py-2 rounded transition-colors text-sm ${view === 'all'
          ...
          <button
            ...
            className={`flex-1 px-3 py-2 rounded transition-colors text-sm ${view === 'saved'
                ? 'bg-primary text-white'
                : 'hover:bg-gray-100 dark:hover:bg-gray-700'
              }`}
          >
              ...
              <div className="flex items-start justify-between gap-2 mb-2">
                ...
                <div className="flex gap-1 flex-shrink-0">
                  ...
                  <button
                    ...
                    className={`p-1 rounded transition-colors ${item.read_later
                        ? 'text-primary'
